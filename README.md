...
- Prices are Google Flights' listed fare price as-is — baggage inclusion
  varies by airline/fare class and isn't filtered on, so check what's
  included at checkout before booking.
